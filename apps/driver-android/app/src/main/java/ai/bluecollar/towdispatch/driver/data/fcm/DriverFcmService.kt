package ai.bluecollar.towdispatch.driver.data.fcm

import ai.bluecollar.towdispatch.driver.MainActivity
import ai.bluecollar.towdispatch.driver.R
import ai.bluecollar.towdispatch.driver.TowDispatchDriverApp
...
class DriverFcmService : FirebaseMessagingService() {
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        val builder = NotificationCompat.Builder(this, TowDispatchDriverApp.CHANNEL_JOB_ALERTS)
