...
import ai.bluecollar.towdispatch.driver.data.local.DriverDatabase
import ai.bluecollar.towdispatch.driver.data.local.JobDao
import ai.bluecollar.towdispatch.driver.data.local.PendingPhotoDao
...
object DatabaseModule {
    ...
    fun provideDatabase(@ApplicationContext context: Context): DriverDatabase {
        return Room.databaseBuilder(context, DriverDatabase::class.java, "towdispatch_driver.db")
