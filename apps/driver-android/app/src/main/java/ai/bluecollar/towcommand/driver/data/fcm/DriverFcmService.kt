package ai.bluecollar.towcommand.driver.data.fcm

import ai.bluecollar.towcommand.driver.MainActivity
import ai.bluecollar.towcommand.driver.R
import ai.bluecollar.towcommand.driver.TowCommandDriverApp
...
class DriverFcmService : FirebaseMessagingService() {
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        val builder = NotificationCompat.Builder(this, TowCommandDriverApp.CHANNEL_JOB_ALERTS)
