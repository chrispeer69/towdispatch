...
import ai.bluecollar.ustowdispatch.driver.BuildConfig
import ai.bluecollar.ustowdispatch.driver.data.api.AuthInterceptor
import ai.bluecollar.ustowdispatch.driver.data.api.TokenAuthenticator
...
object NetworkModule {
    ...
    @Provides @Singleton
    fun provideApi(retrofit: Retrofit): UsTowDispatchApi = retrofit.create(UsTowDispatchApi::class.java)
}
