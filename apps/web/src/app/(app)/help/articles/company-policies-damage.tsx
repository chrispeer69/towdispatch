...
export function DamageClaimArticle(): JSX.Element {
  return (
    <div className="pb-12">
      <P>
        When a customer or motor club claims your driver damaged a vehicle, the speed and structure
        of your response dictates whether you pay a $1,200 body shop bill or dismiss the claim
        entirely.
      </P>
      <P>
      ...
      <H2>Overview</H2>
      <P>
        The key to winning a damage dispute is the <Em>60-second walkaround video</Em> captured by
        your driver before hooking the vehicle. If the driver followed protocol, you have
        irrefutable, timestamped, GPS-tagged proof of the vehicle's condition prior to your company
        taking custody.
      </P>
      <P>
        Never argue with a customer over the phone. Acknowledge their complaint, tell them you will
        review the driver's video evidence, and move the conversation to email. Written
        communication prevents escalation and provides a paper trail for your insurance provider if
        needed.
      </P>

      <Callout tone="tip" title="The Burden of Proof">
        In a damage claim, the burden of proof is on the customer to show that the damage occurred{' '}
        <Em>while the vehicle was in your custody</Em>. By providing a video showing the damage
        already existed at the pickup location, you shift the burden back to them, ending the
        dispute 95% of the time.
      </Callout>
      ...
      <OrderedList>
        ...
        <li>
          Watch the video carefully. Look for the specific panel or area the customer is claiming
          was damaged.
        </li>
      </OrderedList>
      ...
      <P>
        Do not download the video and try to email it as an attachment (it will likely be too
        large). Instead, use the platform's secure sharing feature.
      </P>
      <OrderedList>
        <li>
      ...
      <P>
        Use the template below to respond to the customer or motor club adjuster. Be polite, firm,
        and factual.
      </P>
      ...
      <div className="mt-6 rounded-[10px] border border-divider bg-bg-surface-elevated/20 p-6 font-serif text-sm leading-relaxed text-text-primary-on-dark/80">
        <h4 className="mb-4 text-lg font-bold text-text-primary-on-dark">
          Damage Claim Rejection Template
        </h4>

        <p className="mb-4">
          Subject: Damage Claim Review - Job #[Job Number] - [Customer Name/Vehicle]
        </p>
        <p className="mb-4">Dear [Customer Name / Adjuster Name],</p>
        <p className="mb-4">
          We have received your inquiry regarding alleged damage to the [Year Make Model] serviced
          on [Date of Service]. We take all damage claims seriously and have completed a full review
          of the dispatch record.
        </p>
        <p className="mb-4">
          As part of our standard operating procedure, our drivers capture a continuous video
          walkaround of every vehicle prior to hooking or taking custody. We have reviewed the video
          for this dispatch.
        </p>
        <p className="mb-4">
          The video clearly shows that the damage in question (specifically the [describe damage,
          e.g., scrape on the front left bumper]) was already present on the vehicle at the time our
          driver arrived on scene, prior to any service being rendered.
        </p>
        <p className="mb-4">
          You can view the timestamped, GPS-tagged video evidence directly at the secure link below:
        </p>
        <p className="mb-4 text-brand-primary">[Insert Secure Share Link Here]</p>
        <p className="mb-4">
          Because this damage was pre-existing, we must respectfully deny this claim. We consider
          this matter closed.
        </p>
        <p className="mb-4">
          Sincerely,
      ...
      <OrderedList>
        <li>
          If the claim came through a motor club portal (e.g., Agero's network portal), paste the
      ...
      <div className="mt-6 space-y-4">
        <div className="rounded-[10px] border border-divider bg-bg-surface p-5">
          ...
          <UnorderedList>
            <li>
              <Em>Review the photos.</Em> If the driver skipped the video but took photos, review
              them to see if the pre-existing damage is visible.
            </li>
            <li>
              <Em>If no evidence exists:</Em> You are in a difficult position. If the customer is
              adamant, you may have to file a claim with your insurance or settle out of pocket. Use
              this as a training moment: remind the driver that failing to capture a walkaround
              video makes them personally responsible for explaining the gap in protocol.
            </li>
          </UnorderedList>
        </div>
        ...
        <div className="rounded-[10px] border border-divider bg-bg-surface p-5">
          ...
          <UnorderedList>
            <li>
              <Em>Own it immediately.</Em> Do not try to hide the video. Contact the customer,
              apologize, and initiate your insurance claim process. Transparency in these rare
              moments builds long-term trust, especially with commercial accounts.
            </li>
          </UnorderedList>
        </div>
      </div>
      ...
      <div className="space-y-4 mt-6">
        <div>
          <strong className="block text-text-primary-on-dark">
            Can the customer download the video from the share link?
          </strong>
          <p className="mt-1 text-sm text-text-secondary-on-dark">
            No. The share link opens a secure media player in their browser. They can watch it as
            many times as they want, but there is no direct download button. This prevents the file
            from being manipulated.
          </p>
        </div>
        <div>
          <strong className="block text-text-primary-on-dark">
            Will Stripe accept this video for a chargeback dispute?
          </strong>
          <p className="mt-1 text-sm text-text-secondary-on-dark">
            Yes. When responding to a Stripe dispute, you can provide the secure share link in your
            evidence submission, along with the signed Bill of Lading.
          </p>
        </div>
      </div>
