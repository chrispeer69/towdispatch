...
export function RedAlertArticle(): JSX.Element {
  return (
    <div className="pb-12">
      ...
      <P>
        This guide explains how the RED ALERT digest is generated, how the system decides what is
        "past due," and how to manage which team members receive the email.
      </P>

      <H2>Overview</H2>
      <P>
        Every Monday at 6:00 AM (Eastern Time), the platform runs a background job across your
        entire ledger. It looks at every posted invoice, compares its age to the delinquency
        threshold of the customer who owes it, and tallies up the leaked revenue.
      </P>
      <P>
        If your business has zero past-due invoices, the system stays quiet. If even one invoice is
        delinquent, the system generates the RED ALERT digest and emails it to the Owner and all
        subscribed Admins.
      </P>

      <Callout tone="tip" title="The Goal">
        The RED ALERT is designed to smack you on the shoulder on Monday morning and point at the
        money sitting on the table. It turns A/R from a passive accounting task into an active,
        unavoidable priority for the week.
      </Callout>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        <div className="rounded-[10px] border border-divider bg-bg-surface-elevated/20 p-5">
          ...
          <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-text-secondary-on-dark">
            <li>
              The system uses the <Em>Default Delinquency Days</Em> setting from{' '}
              <Em>Settings → Invoice Defaults</Em>.
            </li>
            <li>
              If the default is 0 days, a cash invoice becomes Past Due at midnight on the day it is
              posted.
            </li>
          </ul>
        </div>
        <div className="rounded-[10px] border border-divider bg-bg-surface-elevated/20 p-5">
          ...
          <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-text-secondary-on-dark">
            <li>
              The system checks the <Em>Delinquency Days</Em> setting on the specific Account
              record.
            </li>
            <li>
              If Agero is set to 30 days, an invoice posted on May 1st is not flagged in the RED
              ALERT until May 31st.
            </li>
          </ul>
        </div>
      </div>
      ...
      <OrderedList>
        ...
        <li>
          You see:{' '}
          <Code>Cash Customer (Maria Sanchez), 1 invoice, oldest 3 days overdue, $150.00</Code>.
        </li>
      </OrderedList>
      ...
      <OrderedList>
        <li>
          Click the <Code>Open A/R Workspace</Code> link in the email. This drops you directly into
          the platform, pre-filtered to show only Past Due invoices.
        </li>
        <li>
          Select the two AAA invoices and click <Code>Send Reminder Email</Code>.
        </li>
        <li>Call Maria Sanchez directly regarding the cash invoice.</li>
      </OrderedList>

      <H2>Managing Who Receives the Alert</H2>
      <P>You can control which members of your team receive the Monday morning digest.</P>
      <OrderedList>
        <li>
        ...
        <li>
          Users with the <Code>Owner</Code> or <Code>Admin</Code> role display a locked "Always"
          badge. They receive the digest automatically by virtue of their role, and cannot be opted
          out.
        </li>
        <li>
          For other roles (e.g., <Code>Manager</Code> or <Code>Accounting</Code>), you will see a
          toggle switch. Click the toggle to subscribe or unsubscribe that user from the digest.
        </li>
      </OrderedList>
      ...
      <div className="mt-6 space-y-4">
        <div className="rounded-[10px] border border-divider bg-bg-surface p-5">
          ...
          <UnorderedList>
            <li>
              <Em>Do you actually have past-due invoices?</Em> The system only sends the email if
              the past-due balance is greater than zero. If your A/R is clean, or if all unpaid
              invoices are still within their grace period, the system stays quiet.
            </li>
            <li>
              <Em>Check your spam folder.</Em> If this is your first week on the platform, your
              email provider may have filtered the message. Mark it as "Not Spam" to ensure future
              delivery.
            </li>
          </UnorderedList>
        </div>
      ...
      <div className="space-y-4 mt-6">
        <div>
          <strong className="block text-text-primary-on-dark">
            Can I change the day or time the email sends?
          </strong>
          <p className="mt-1 text-sm text-text-secondary-on-dark">
            Not currently. The cron job is hardcoded to run globally at 6:00 AM Eastern Time every
            Monday. This ensures a consistent operational cadence across the platform.
          </p>
        </div>
        <div>
          <strong className="block text-text-primary-on-dark">
            Does the RED ALERT email go to the customer?
          </strong>
          <p className="mt-1 text-sm text-text-secondary-on-dark">
            No. The RED ALERT digest is an internal report sent only to your team. You must manually
            choose to send reminder emails to customers from the A/R Workspace.
          </p>
        </div>
      </div>
