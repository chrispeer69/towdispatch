...
export function StatementGenerationArticle(): JSX.Element {
  return (
    <div className="pb-12">
      <P>
        Motor clubs and commercial fleets do not pay per invoice. They pay from a consolidated
        monthly or bi-weekly statement. Generating these statements accurately, applying payments
        against them, and tracking the remaining balance is a core accounting function.
      </P>
      <P>
        This guide explains how to generate a statement for a specific account, how the system
        handles carry-forward balances, and how to email the PDF statement directly to the motor
        club's accounts payable department.
      </P>

      <H2>Overview</H2>
      <P>
        A Statement is a snapshot in time. It shows the starting balance for an account, lists every
        invoice issued and payment received during a specific date range, and calculates the ending
        balance.
      </P>
      <P>
      ...
      <Callout tone="tip" title="The difference between Invoices and Statements">
        An <Em>Invoice</Em> is a bill for a single tow job. A <Em>Statement</Em> is a summary of all
        invoices and payments for a single Account over a period of time. You send Invoices to cash
        customers. You send Statements to motor clubs.
      </Callout>

      <H2>Worked Example: Month-End Billing for Agero</H2>
      <P>
        It is the 1st of the month. You need to send Agero their statement for all tows completed
        last month.
      </P>
      ...
      <OrderedList>
        ...
        <li>
          You will see a list of all previously generated statements. Click{' '}
          <Code>Generate Statement</Code> in the top right.
        </li>
      </OrderedList>
      ...
      <OrderedList>
        ...
        <li>
          Select the date range. You can use the quick-select buttons (e.g., <Code>Last Month</Code>
          ) or manually pick the 1st through the 30th/31st.
        </li>
        <li>
      ...
      <P>
        The system compiles the statement and displays a preview on your screen. You should verify
        three things:
      </P>
      <UnorderedList>
        <li>
          <Em>Starting Balance:</Em> Does this match what Agero owed you at the end of the previous
          month? (If they haven't paid last month's statement yet, this number will be greater than
          zero).
        </li>
        <li>
          <Em>New Invoices:</Em> Scan the list of invoices generated during the month.
        </li>
        <li>
          <Em>Payments Received:</Em> Scan the list of payments recorded during the month.
        </li>
      </UnorderedList>
      ...
      <OrderedList>
        <li>
          If the preview looks correct, click <Code>Finalize Statement</Code>. The system generates
          a formal PDF document with your company logo, remit-to address, and the line-item
          breakdown.
        </li>
        <li>
        ...
        <li>
          The email modal pre-populates with the billing email address configured on the Agero
          account. You can add CCs if needed. Click <Code>Send</Code>.
        </li>
      </OrderedList>
      ...
      <div className="mt-6 space-y-4">
        <div className="rounded-[10px] border border-divider bg-bg-surface p-5">
          ...
          <UnorderedList>
            <li>
              <Em>Is the invoice still a Draft?</Em> Statements only include <Em>Posted</Em>{' '}
              invoices. If an invoice is still in Draft status, it will not appear on the statement,
              even if the job was completed during the date range. Post the invoice, then regenerate
              the statement.
            </li>
            <li>
              <Em>Check the invoice date.</Em> The statement pulls invoices based on their{' '}
              <Em>Posted Date</Em> (issued_at), not the date the tow occurred. If the tow happened
              on the 31st, but your accounting team didn't post the invoice until the 2nd of the
              next month, that invoice belongs on the next month's statement.
            </li>
          </UnorderedList>
        </div>
      ...
      <div className="space-y-4 mt-6">
        <div>
          <strong className="block text-text-primary-on-dark">
            Can I generate statements in bulk for all motor clubs?
          </strong>
          <p className="mt-1 text-sm text-text-secondary-on-dark">
            Not currently. Statements must be generated one account at a time. This is an
            intentional design choice to force a manual review of the starting balance and invoice
            list before a PDF is sent to a major commercial partner.
          </p>
        </div>
        <div>
          <strong className="block text-text-primary-on-dark">
            Does generating a statement push data to QuickBooks?
          </strong>
          <p className="mt-1 text-sm text-text-secondary-on-dark">
            No. Invoices and payments sync to QuickBooks individually as they happen. The Statement
            is just a PDF summary of those individual transactions. You do not need to sync the
            statement itself to QBO.
          </p>
        </div>
      </div>
