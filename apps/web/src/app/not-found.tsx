 ...
 *
 * Branded shell so the user knows they hit a real Tow Dispatch page and not
    ...
    <main className="flex min-h-screen items-center justify-center bg-bg-base px-6 py-12">
      ...
      >
        ...
        <p className="mb-6 max-w-md text-sm text-text-secondary-on-dark">
          ...
          link inside Tow Dispatch, the record may have been deleted or moved to a different tenant.
        </p>
