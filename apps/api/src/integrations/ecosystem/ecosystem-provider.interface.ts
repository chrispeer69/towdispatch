...
export interface EcosystemPartnerCredentials {
  /** Vendor-specific configuration. Opaque to Tow Dispatch core. */
 ...
 * implementations validate and surface a normalized event to Tow Dispatch.
 */
 ...
 * Tow Dispatch's hands for a downstream service (repair, body, rental). Each
