...
import { ERROR_CODES, type ProblemDetails } from '@towdispatch/shared';
...
export class GlobalExceptionFilter implements ExceptionFilter {
  constructor(
    ...
    let problem: ProblemDetails = {
      type: `https://errors.towdispatch.com/${ERROR_CODES.INTERNAL_ERROR}`,
    ...
    if (exception instanceof ZodError) {
      ...
      problem = {
        type: `https://errors.towdispatch.com/${ERROR_CODES.VALIDATION_FAILED}`,
      ...
      problem = {
        type: `https://errors.towdispatch.com/${code}`,
