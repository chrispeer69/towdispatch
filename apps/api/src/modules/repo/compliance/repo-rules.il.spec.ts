/**
 * Repo rule-engine spec — IL (UCC + 815 ILCS 375, 21-day cure).
 */
...
const R = REPO_STATE_RULES.IL;
const ST = 'IL' as const;

describe('repo rules — IL', () => {
  it('config matches the IL statute profile', () => {
    expect(R.postRepoNoticeDays).toBe(10);
    expect(R.redemptionPeriodDays).toBe(0);
    expect(R.cureRightDays).toBe(21);
