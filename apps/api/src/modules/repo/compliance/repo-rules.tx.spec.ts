/**
 * Repo rule-engine spec — TX (UCC + Finance Code 348, post-sale deficiency, no pre-sale redemption).
 */
...
const R = REPO_STATE_RULES.TX;
const ST = 'TX' as const;

describe('repo rules — TX', () => {
  it('config matches the TX statute profile', () => {
    expect(R.postRepoNoticeDays).toBe(5);
  ...
  it('after recovery, sends the post-repossession notice within 5 days', () => {
