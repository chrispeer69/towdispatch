/**
 * Repo rule-engine spec — FL (UCC 679.609 + recovery-agent licensing, post-sale deficiency).
 */
...
const R = REPO_STATE_RULES.FL;
const ST = 'FL' as const;

describe('repo rules — FL', () => {
  it('config matches the FL statute profile', () => {
